...
def keys():
    ...
    if not SW2.value:
        ...
        keyboard.press(Keycode.LEFT_CONTROL, Keycode.LEFT_ALT, Keycode.LEFT_GUI, Keycode.F12 )
        time.sleep(0.2)
        keyboard.release(Keycode.LEFT_CONTROL, Keycode.LEFT_ALT, Keycode.LEFT_GUI, Keycode.F12 )

    if not SW3.value:
        print("switch 3 pressed")
        keyboard.press(Keycode.LEFT_CONTROL, Keycode.LEFT_ALT, Keycode.LEFT_GUI, Keycode.F11 )
        time.sleep(0.2)
        keyboard.release(Keycode.LEFT_CONTROL, Keycode.LEFT_ALT, Keycode.LEFT_GUI, Keycode.F11 )
