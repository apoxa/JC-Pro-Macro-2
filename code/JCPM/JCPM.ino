...
int modeArray[] = {0, 1, 2, 3}; // adjust this array to modify sequence of modes - as written, change to {0, 1, 2, 3, 4, 5} to access all modes
...
void loop()
{
  ...
  {
    screenProgram();
    delay(43200000); // Wait for 12 Hours to reprogram, should be more than enough
  }
...
void volume()
{
  ...
  if ((SW7 == 0) && (underLight == 0))
  {
    ...
    for (int i = 8; i < 12; i++)
    {
      pixels.setPixelColor(i, pixels.Color(140, 255, 130));
    }
